          ...
          >
            ...
            <motion.div variants={fadeInUp} className="flex flex-wrap gap-6 justify-center">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="px-10 py-5 rounded-2xl font-semibold glass border border-white/10 text-white flex items-center gap-3 text-lg hover:bg-[#111111]/5 cursor-pointer"
              >
                View Demo
              </motion.a>
            </motion.div>
      ...
      <div className="w-full flex flex-col items-center max-w-7xl mx-auto px-4 md:px-20">
        ...
        >
          <div className="py-10 md:py-40 w-full relative" style={{ perspective: '1000px' }}>
            ...
            >
              <div className="h-full w-full overflow-hidden rounded-2xl bg-[#111111] md:rounded-2xl p-4 md:p-8">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 h-full">
                  ...
                  <div className="col-span-2 md:col-span-4 glass rounded-2xl p-4 md:p-6 border border-white/10">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-3 p-2 rounded-xl bg-[#111111]/5">
    ...
    <section id="team" className="py-56 relative w-full flex flex-col items-center">
      ...
      <div className="w-full flex flex-col items-center max-w-7xl mx-auto px-6">
        ...
        <div className="relative w-full">
          <button
            onClick={() => scroll('left')}
            className="absolute left-2 md:left-4 top-1/2 -translate-y-1/2 z-10 h-12 w-12 rounded-full glass border border-white/10 flex items-center justify-center hover:bg-[#111111]/20 transition-all"
          >
          ...
          <button
            ...
            className="absolute right-2 md:right-4 top-1/2 -translate-y-1/2 z-10 h-12 w-12 rounded-full glass border border-white/10 flex items-center justify-center hover:bg-[#111111]/20 transition-all"
          >
...
function App() {
  return (
    <div className="min-h-screen bg-[#111111] w-full flex flex-col items-center">
      <Navbar />
      <Hero />
      <AppPreview />
      <Journey />
